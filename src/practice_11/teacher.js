...
class Teacher extends Person {
    ...
    notifyLeaderAssigned(klassNumber, studentName) {
        console.log(`I am ${this.name}. I know ${studentName} become Leader of Class ${klassNumber}.`);
    }

    notifyNewMember(klassNumber, studentName) {
        console.log(`I am ${this.name}. I know ${studentName} has joined Class ${klassNumber}.`);
    }
